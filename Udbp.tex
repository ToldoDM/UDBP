...
\begin{document}
	...
	\textbf{Operazione 6}: Conteggio totale posti venduti per ogni spettacolo (1 volta al giorno)
	...
	\begin{itemize}
		...
		\end{itemize}
	\end{itemize}
	operazione 1: programmazione di uno spettacolo in una sala (40 volte al giorno)
	operazione 2: Emissione biglietti (2500 volte al giorno)
	operazione 3: arrivi di nuovi film (5 volte al mese)
	operazione 4: rilascio di una recensione (2200 volte al giorno)
	operazione 5: aggiunta di un nuovo cast (4 volte al mese)
