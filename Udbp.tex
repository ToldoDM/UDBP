...
\begin{document}
	...
	\paragraph{Persona}
	La generalizzaione \textit{Persona}, che rappresenta una persona che e' un cliente del cinema, ha come figlia l'entita' \textit{Lavoratore}, che in questo caso viene considerato come il lavoratore che prende parte alla realizzazione di un film.\\
