...
\begin{document}
	...
	Essendo D4C cinemas una catena, e' necessario identificare la localita' di ciascun {\bf Cinema}:
	\begin{itemize}
		\item Nome cinema
		\item Numero sale
	...
	\end{itemize}
	Per ogni {\bf Sala} vine assegnato un entità {\bf Spettacolo} contenente, in quanto necessaria per l'organizzazioni degli orari di proiezione:
	\begin{itemize}
	    \item data/orario
	\end{itemize}
	...
	\textbf{Operazione 6}: Conteggio totale posti venduti per ogni spettacolo (1 volta a settimana)
 	...
 	\begin{tabular}{ |p{3cm}|p{4.5cm}|p{2.5cm}|p{3cm}|  }
 		...
 		Lavoratore                                & Persona singola che lavora                 & Attore, Sceneggiatore, Produttore, Regista & Cast, Persona                                                                        \\ \hline
 		Cast & Lavoratore che fa parte del film &  & Lavoratore,Film \\ \hline 
 		
 		Persona & Sia soggetto pagante che soggetto lavorante & & Recesione, Biglietto
 		        \\ \hline
	...
	\includegraphics[height=\textwidth, width=20cm, angle=90]{SchemaER_Rev}
	...
	\textbf{Biglietto}(\underline{Id}, n\_posto, Id\_Spettacolo, Id\_Persona)\\
