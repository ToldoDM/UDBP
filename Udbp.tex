...
\begin{document}
	...
	L'attributo \textbf{posti\_venduti}, cosi' come indicato nello schema ER, indica il numero totale di posti venduti per uno spettacolo (accessi in scrittura vengono considerati come operazioni piu onerose, quindi vengono contate due volte).\\\\
	...
	\end{tabular}
	\begin{itemize}
	\item Costi 1*100 = 100 accessi 
	\end{itemize}
	Il totale degli accessi, essendo l'operazione 2 giornaliera e l'operazione 6 settimanale, si calcola in questo modo: 17500*7 + 100 = 122600 accessi.
