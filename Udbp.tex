...
\begin{document}
	...
	\includegraphics[width=\textwidth, height=16.1cm]{Schemas/SchemaER_Rev}
	...
	\begin{itemize}
		...
		\item Che la stessa venga consultata spesso per l'orario inizio spettacoli
		...
		\item Che la stessa viene consultata spesso per il titolo del film
		\item La tabella \textbf{Persona} contanga molte tuple
		\item Nella tabella \textbf{Persona} vengono aggiunti spesso nuove tuple
		\item Che la stessa venga colsultata spesso per la ricerca di un film dove ha partecipato uno specifico attore, ricercandolo per cognome
	\end{itemize}
	\subsection{Riconoscimento tabelle da indicizzare}
	\subsection{Implementazione dell'indice}
\end{document}
